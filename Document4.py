...
st.title('Normalitas dan Kadar')
st.text('Normalitas adalah ukuran yang menunjukkan konsentrasi dengan berat setara dalam gram per liter larutan, dimana berat setara itu sendiri adalah ukuran kapasitas reaktif dari suatu molekul yang terlarut dalam larutan. Dalam reaksi, peran zat terlarut tersebut adalah akan menentukan normalitas suatu larutan.')
st.text('Persentase berat per volume (% b/v) Persentase b/v adalah jumlah gram zat terlarut dalam tiap 100 ml larutan. %b/v= x100% Satuan %b/v umumnya dipakai untuk zat terlarut padat dalam pelarut cair.')
st.text('Persen b/b adalah jumlah gram zat terlarut dalam tiap 100 gram larutan. %b/b = x100% Contoh: Larutan cuka sebanyak 40 gram mengandung asam asetat sebanyak 2 gram.')
